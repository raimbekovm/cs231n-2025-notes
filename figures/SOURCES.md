...
| File              | Status               | Source                                                                                                                                                                                                                                                                                                          |
| :---------------- | :------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `readme-hero.svg` | own work | Drawn for this project by `figures/make_readme_hero.py`. The arc of the course as six motifs — pixels, a linear boundary, a convolutional stack, a residual shortcut, a causal attention matrix, objects with boxes and a mask. Unlike every other figure here it sets ink and background explicitly instead of using `currentColor`, because a README image is rendered in isolation inside an `<img>` where `currentColor` falls back to black and disappears on GitHub's dark theme. The plate is `#eef1f5`, the same value `theme-dark.scss` gives `$cs-figure-plate`. |
