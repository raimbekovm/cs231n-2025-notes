...
| #   | Topic                                        | Read                                                                                                      | Status   |
| :-- | :------------------------------------------- | :-------------------------------------------------------------------------------------------------------- | :------- |
| 1   | Introduction                                 | [Online](https://raimbekovm.github.io/cs231n-2025-notes/lectures/01-introduction.html)                    | Complete |
| 2   | Image Classification with Linear Classifiers | [Online](https://raimbekovm.github.io/cs231n-2025-notes/lectures/02-image-classification.html)            | Complete |
| 3   | Regularization and Optimization              | [Online](https://raimbekovm.github.io/cs231n-2025-notes/lectures/03-regularization-optimization.html)     | Complete |
| 4   | Neural Networks and Backpropagation          | [Online](https://raimbekovm.github.io/cs231n-2025-notes/lectures/04-neural-networks-backpropagation.html) | Complete |
...
- Continuous prose rather than bullet points — each chapter is written to be
  read straight through, without the video open alongside it
- Mathematical formulations alongside the intuition behind them, with every
  load-bearing result derived rather than asserted
- Diagrams drawn for this project, generated by a script committed beside them
- Links to the original paper for every named result, never to a summary
...
│                          #   diagram_*.svg ship with the source that draws
│                          #   them — TikZ, or a make_diagrams.py per chapter
